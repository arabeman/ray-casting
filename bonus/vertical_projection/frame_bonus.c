...
/*   Updated: 2025/03/02 18:13:49 by arabeman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// put this in the last line of the function if you want to add weapon
// render_player_weapon(data);
void	render_frame(t_data *data)
{
	...
	while (col < WIN_WIDTH)
	{
		...
		render_floor_ceiling(data, col, &rd);
